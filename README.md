...
I like figuring out how things work and then building my own version of them. Right now, I’m exploring web and app development — learning, experimenting, and improving with each project.

## 🔭 What I'm Up To

- Experimenting with full-stack applications using the MERN stack (MongoDB, Express.js, React, Node.js).
- Learning to develop mobile apps with Flutter, focusing on clean architecture and state management.
